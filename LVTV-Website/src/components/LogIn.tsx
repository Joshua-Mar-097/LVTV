...
export default function LogIn({ isOpen, onClose }: LoginModalProps) {
  ...
  return (
    <div className={`modal ${modalVisible ? 'visible' : 'hidden'}`}>
      {/* Move the link tag to index.html or index.js for better practice */}
      {/* <link rel="stylesheet" href="https://unpkg.com/@themesberg/flowbite@1.2.0/dist/flowbite.min.css" /> */}
      <div className="max-w-2xl mx-auto">
        <div
          id="authentication-modal"
          aria-hidden="true"
          className={`overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center ${modalVisible ? 'visible' : 'hidden'}`}
        >
          <div className="relative w-full max-w-md px-4 h-full md:h-auto">
            <div className="bg-white rounded-lg shadow relative dark:bg-gray-700">
              <div className="flex justify-end p-2">
